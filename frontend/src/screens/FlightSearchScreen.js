...
const FlightSearchScreen = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate(`/flightSearch/?origin=${origin}&destination=${destination}`);
    console.log(flight);
  };
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center items-center bg-gray-900">
        <div className="flex flex-row item-center justify-center">
          <div className="flex m-1 form-floating mb-3 xl:w-96 h-24 ">
            <input
              type="text"
              name="origin"
              id="origin"
              ...
              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-xl text-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-64  pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            />
          </div>
          <div className="flex m-1 form-floating mb-3 xl:w-96 h-24">
            <input
