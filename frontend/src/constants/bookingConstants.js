...
export const COMPLETED_BOOKING_DETAILS_REQUEST =
  "COMPLETED_BOOKING_DETAILS_REQUEST";
export const COMPLETED_BOOKING_DETAILS_SUCCESS =
  "COMPLETED_BOOKING_DETAILS_SUCCESS";
export const COMPLETED_BOOKING_DETAILS_FAIL = "COMPLETED_BOOKING_DETAILS_FAIL";
